...
(define partially-balanced-mobile (make-mobile (make-branch 1 (make-mobile (make-branch 3 (make-mobile (make-branch 1 2)
                                                                                                       (make-branch 1 2)
                                                                                          )
                                                                           )
                                                                           (make-branch 1 12)
                                               ...
                                               (make-branch 1 1000000000000000000000000)
                                  )
)
...
(let ((test-name "Balanced Test (exercise c)"))
  ...
  (test-assert (balanced? partially-balanced-mobile))
  (test-end test-name)
)
